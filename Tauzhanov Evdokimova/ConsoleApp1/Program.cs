                ...
                case 1:
                    ...
                    while (run)
                    {
                        ...
                        if (vibo == 1)
                        {
                            ...
                            string Books = @"..\файлики\books.txt";
                        ...
                        if (vibo == 2)
                        {
                            ...
                            string AuthorId = @"..\файлики\authors.txt";
                        ...
                        if (vibo == 3)
                        {
                            ...
                            string GenreId = @"..\файлики\genres.txt";
                    ...
                    while (running)
                    {
                        ...
                        switch (Console.ReadLine())
                        {
                            ...
                            case "2":
                                ...
                                string filetxtbook = @"..\файлики\books.txt";
                                ...
                                string booksUpdate = @"..\файлики\books.txt";
                            ...
                            case "3":
                                ...
                                // код delete book
                                string filePath = @"..\файлики\books.txt";
